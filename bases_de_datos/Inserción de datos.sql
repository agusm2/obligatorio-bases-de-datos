...
VALUES ('12345678', 'Matias', 'Hernandez', 'matiher123@correo.com'),
       ('87654321', 'Jerónimo', 'González', 'jerogon123@correo.com'),
       ('02345678', 'José', 'Abadie', 'joaba123@correo.com');

INSERT INTO obligatorio.facultad(nombre)
VALUES ('Facultad de Ingeniería'),
       ('Facultad de Ciencias'),
       ('Facultad de Medicina');

INSERT INTO obligatorio.edificio(nombre_edificio, direccion, departamento)
VALUES ('Central', '8 de octubre', 'Montevideo'),
       ('Campo', 'Rural 123', 'Salto'),
       ('UTP', 'Gorlero 123', 'Rocha');

INSERT INTO obligatorio.turno(hora_inicio, hora_fin)
VALUES ('09:00', '13:00'),
       ('10:00', '15:00'),
       ('12:00', '17:00');
...
VALUES ('12345678', 'Experto en ciberseguridad', 'alumno'),
